...
== Rich Picture
To effectively develop the necessary system, it’s essential to have a clear understanding of the task that will be encountered by the system. One useful approach is to create a rich picture, which is a visual representation that should help get a better understanding of the task. To make it clearer, a rich picture is a diagram using simple symbols and illustrations. The connection between these elements should help to provide a detailed and comprehensive overview, covering both the problem and application domains for the system.
