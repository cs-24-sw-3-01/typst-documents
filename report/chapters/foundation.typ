...
their project portfolio manager, Caroline Ramsdal and their manager of modern workplace, Dion Andersen, respectivley. #todo[er det ikke lidt fokert at nævne deres navne ( person beskyttelse) - zafir ] 
...
a way of viewing the vacation #todo[purpose of kmdferie = at se vacation for et team og lave teams- zafir] registered in SAP SuccessFactors, with the ability to override by manually registering vacations, when not possible in SAP SuccessFactors.
...
=== R - (Responsibility)
The system is intended to ensure transparency in absence management across the organization. It provides a clear view of team members' absence schedules, helping to prevent scheduling conflicts and enabling better planning for upcoming work periods. The system has to be able to integrate with KMD's current SAP system. communcation between SAP and the system should go both ways, so the SAP data should be able to be imported to the system and vice versa. #todo[hvad skal overføres fra absenceplanner til SAP er det ikke kun den ene vej den går - zafir]
